package com.example.slidebacklib;
...
public abstract class BaseBackActivity extends AppCompatActivity {
    ...
    public void setUnslideView(View unslideView) {
        this.unslideView = unslideView;
    }
    ...
    public class SlideFrame extends FrameLayout {
        ...
        public boolean dispatchTouchEvent(MotionEvent ev) {
            if (unslideView != null) {
                Rect rect = new Rect();
                unslideView.getGlobalVisibleRect(rect);
